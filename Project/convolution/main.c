...
//////////////////////////////////////////////////////////////////////////////
// Convolution baseline code -- you have to optimization it !
//////////////////////////////////////////////////////////////////////////////
...
void run(unsigned int width, unsigned int height,
    ...
    // Run the code and calculate Cycles Per Element (CPE)
    double num_pixels = width * height;
    double cpe_baseline = measure((func_t)filter_baseline, args) / num_pixels;
    args[3] = (void*)output2;
    double cpe_optimized = measure((func_t)filter_optimized, args) / num_pixels;
    ...
    if (compare(output1, output2, width, height) < 10) {
        ...
        printf("CPE baseline:\t%lf\n", cpe_baseline);
        printf("CPE optimized:\t%lf\n", cpe_optimized);
        printf("Your speedup:\t%lf\n", cpe_baseline / cpe_optimized);
    }
}
